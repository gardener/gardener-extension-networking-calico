...
func RenderCalicoChart(
	...
	values, err := ComputeCalicoChartValues(network, config, workerSystemComponentsActivated, kubernetesVersion, wantsVPA, kubeProxyEnabled, isPSPDisabled, nonPrivileged)
	if err != nil {
		return nil, err
	}
