...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*KubeAPIServerEndpoints)(nil), (*calico.KubeAPIServerEndpoints)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_KubeAPIServerEndpoints_To_calico_KubeAPIServerEndpoints(a.(*KubeAPIServerEndpoints), b.(*calico.KubeAPIServerEndpoints), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*calico.KubeAPIServerEndpoints)(nil), (*KubeAPIServerEndpoints)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_calico_KubeAPIServerEndpoints_To_v1alpha1_KubeAPIServerEndpoints(a.(*calico.KubeAPIServerEndpoints), b.(*KubeAPIServerEndpoints), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_KubeAPIServerEndpoints_To_calico_KubeAPIServerEndpoints is an autogenerated conversion function.
func Convert_v1alpha1_KubeAPIServerEndpoints_To_calico_KubeAPIServerEndpoints(in *KubeAPIServerEndpoints, out *calico.KubeAPIServerEndpoints, s conversion.Scope) error {
	return autoConvert_v1alpha1_KubeAPIServerEndpoints_To_calico_KubeAPIServerEndpoints(in, out, s)
}
...
// Convert_calico_KubeAPIServerEndpoints_To_v1alpha1_KubeAPIServerEndpoints is an autogenerated conversion function.
func Convert_calico_KubeAPIServerEndpoints_To_v1alpha1_KubeAPIServerEndpoints(in *calico.KubeAPIServerEndpoints, out *KubeAPIServerEndpoints, s conversion.Scope) error {
	return autoConvert_calico_KubeAPIServerEndpoints_To_v1alpha1_KubeAPIServerEndpoints(in, out, s)
}
...
func autoConvert_v1alpha1_NetworkConfig_To_calico_NetworkConfig(in *NetworkConfig, out *calico.NetworkConfig, s conversion.Scope) error {
	...
	out.KubeAPIServerEndpoints = (*calico.KubeAPIServerEndpoints)(unsafe.Pointer(in.KubeAPIServerEndpoints))
	return nil
}
...
func autoConvert_calico_NetworkConfig_To_v1alpha1_NetworkConfig(in *calico.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	...
	out.KubeAPIServerEndpoints = (*KubeAPIServerEndpoints)(unsafe.Pointer(in.KubeAPIServerEndpoints))
	return nil
}
