...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*KubeAPIServerGlobalNetworkSet)(nil), (*calico.KubeAPIServerGlobalNetworkSet)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_KubeAPIServerGlobalNetworkSet_To_calico_KubeAPIServerGlobalNetworkSet(a.(*KubeAPIServerGlobalNetworkSet), b.(*calico.KubeAPIServerGlobalNetworkSet), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*calico.KubeAPIServerGlobalNetworkSet)(nil), (*KubeAPIServerGlobalNetworkSet)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_calico_KubeAPIServerGlobalNetworkSet_To_v1alpha1_KubeAPIServerGlobalNetworkSet(a.(*calico.KubeAPIServerGlobalNetworkSet), b.(*KubeAPIServerGlobalNetworkSet), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_KubeAPIServerGlobalNetworkSet_To_calico_KubeAPIServerGlobalNetworkSet is an autogenerated conversion function.
func Convert_v1alpha1_KubeAPIServerGlobalNetworkSet_To_calico_KubeAPIServerGlobalNetworkSet(in *KubeAPIServerGlobalNetworkSet, out *calico.KubeAPIServerGlobalNetworkSet, s conversion.Scope) error {
	return autoConvert_v1alpha1_KubeAPIServerGlobalNetworkSet_To_calico_KubeAPIServerGlobalNetworkSet(in, out, s)
}
...
// Convert_calico_KubeAPIServerGlobalNetworkSet_To_v1alpha1_KubeAPIServerGlobalNetworkSet is an autogenerated conversion function.
func Convert_calico_KubeAPIServerGlobalNetworkSet_To_v1alpha1_KubeAPIServerGlobalNetworkSet(in *calico.KubeAPIServerGlobalNetworkSet, out *KubeAPIServerGlobalNetworkSet, s conversion.Scope) error {
	return autoConvert_calico_KubeAPIServerGlobalNetworkSet_To_v1alpha1_KubeAPIServerGlobalNetworkSet(in, out, s)
}
...
func autoConvert_v1alpha1_NetworkConfig_To_calico_NetworkConfig(in *NetworkConfig, out *calico.NetworkConfig, s conversion.Scope) error {
	...
	out.KubeAPIServerGlobalNetworkSet = (*calico.KubeAPIServerGlobalNetworkSet)(unsafe.Pointer(in.KubeAPIServerGlobalNetworkSet))
	return nil
}
...
func autoConvert_calico_NetworkConfig_To_v1alpha1_NetworkConfig(in *calico.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	...
	out.KubeAPIServerGlobalNetworkSet = (*KubeAPIServerGlobalNetworkSet)(unsafe.Pointer(in.KubeAPIServerGlobalNetworkSet))
	return nil
}
