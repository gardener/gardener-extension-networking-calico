...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Images)(nil), (*calico.Images)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Images_To_calico_Images(a.(*Images), b.(*calico.Images), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*calico.Images)(nil), (*Images)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_calico_Images_To_v1alpha1_Images(a.(*calico.Images), b.(*Images), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Images_To_calico_Images(in *Images, out *calico.Images, s conversion.Scope) error {
	out.CNIImageName = (*string)(unsafe.Pointer(in.CNIImageName))
	out.NodeImageName = (*string)(unsafe.Pointer(in.NodeImageName))
	out.KubeControllersImageName = (*string)(unsafe.Pointer(in.KubeControllersImageName))
	out.PodToDaemonFlexVolumeDriverImageName = (*string)(unsafe.Pointer(in.PodToDaemonFlexVolumeDriverImageName))
	out.TyphaImageName = (*string)(unsafe.Pointer(in.TyphaImageName))
	out.CalicoClusterProportionalAutoscalerImageName = (*string)(unsafe.Pointer(in.CalicoClusterProportionalAutoscalerImageName))
	out.ClusterProportionalVerticalAutoscalerImageName = (*string)(unsafe.Pointer(in.ClusterProportionalVerticalAutoscalerImageName))
	return nil
}

// Convert_v1alpha1_Images_To_calico_Images is an autogenerated conversion function.
func Convert_v1alpha1_Images_To_calico_Images(in *Images, out *calico.Images, s conversion.Scope) error {
	return autoConvert_v1alpha1_Images_To_calico_Images(in, out, s)
}

func autoConvert_calico_Images_To_v1alpha1_Images(in *calico.Images, out *Images, s conversion.Scope) error {
	out.CNIImageName = (*string)(unsafe.Pointer(in.CNIImageName))
	out.NodeImageName = (*string)(unsafe.Pointer(in.NodeImageName))
	out.KubeControllersImageName = (*string)(unsafe.Pointer(in.KubeControllersImageName))
	out.PodToDaemonFlexVolumeDriverImageName = (*string)(unsafe.Pointer(in.PodToDaemonFlexVolumeDriverImageName))
...
// Convert_calico_Images_To_v1alpha1_Images is an autogenerated conversion function.
func Convert_calico_Images_To_v1alpha1_Images(in *calico.Images, out *Images, s conversion.Scope) error {
	return autoConvert_calico_Images_To_v1alpha1_Images(in, out, s)
}
...
func autoConvert_v1alpha1_NetworkConfig_To_calico_NetworkConfig(in *NetworkConfig, out *calico.NetworkConfig, s conversion.Scope) error {
	...
	out.Images = (*calico.Images)(unsafe.Pointer(in.Images))
...
func autoConvert_calico_NetworkConfig_To_v1alpha1_NetworkConfig(in *calico.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	...
	out.Images = (*Images)(unsafe.Pointer(in.Images))
	out.VethMTU = (*string)(unsafe.Pointer(in.VethMTU))
