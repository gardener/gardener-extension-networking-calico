...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Felix)(nil), (*calico.Felix)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Felix_To_calico_Felix(a.(*Felix), b.(*calico.Felix), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*calico.Felix)(nil), (*Felix)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_calico_Felix_To_v1alpha1_Felix(a.(*calico.Felix), b.(*Felix), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Felix_To_calico_Felix(in *Felix, out *calico.Felix, s conversion.Scope) error {
	out.ServiceLoopPrevention = (*calico.ServiceLoopPrevention)(unsafe.Pointer(in.ServiceLoopPrevention))
	return nil
}

// Convert_v1alpha1_Felix_To_calico_Felix is an autogenerated conversion function.
func Convert_v1alpha1_Felix_To_calico_Felix(in *Felix, out *calico.Felix, s conversion.Scope) error {
	return autoConvert_v1alpha1_Felix_To_calico_Felix(in, out, s)
}

func autoConvert_calico_Felix_To_v1alpha1_Felix(in *calico.Felix, out *Felix, s conversion.Scope) error {
	out.ServiceLoopPrevention = (*ServiceLoopPrevention)(unsafe.Pointer(in.ServiceLoopPrevention))
	return nil
}

// Convert_calico_Felix_To_v1alpha1_Felix is an autogenerated conversion function.
func Convert_calico_Felix_To_v1alpha1_Felix(in *calico.Felix, out *Felix, s conversion.Scope) error {
	return autoConvert_calico_Felix_To_v1alpha1_Felix(in, out, s)
}
...
func autoConvert_v1alpha1_NetworkConfig_To_calico_NetworkConfig(in *NetworkConfig, out *calico.NetworkConfig, s conversion.Scope) error {
	...
	out.Felix = (*calico.Felix)(unsafe.Pointer(in.Felix))
	return nil
}
...
func autoConvert_calico_NetworkConfig_To_v1alpha1_NetworkConfig(in *calico.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	...
	out.Felix = (*Felix)(unsafe.Pointer(in.Felix))
	return nil
}
