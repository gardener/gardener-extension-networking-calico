...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Felix) DeepCopyInto(out *Felix) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Felix.
func (in *Felix) DeepCopy() *Felix {
	if in == nil {
		return nil
	}
	out := new(Felix)
