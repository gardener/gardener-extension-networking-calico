...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubeAPIServerEndpoints) DeepCopyInto(out *KubeAPIServerEndpoints) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubeAPIServerEndpoints.
func (in *KubeAPIServerEndpoints) DeepCopy() *KubeAPIServerEndpoints {
	if in == nil {
		return nil
	}
	out := new(KubeAPIServerEndpoints)
	in.DeepCopyInto(out)
	return out
}
