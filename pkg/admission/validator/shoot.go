...
func (s *shoot) validateShoot(_ context.Context, shoot *core.Shoot) error {
	if shoot.Spec.Kubernetes.KubeProxy != nil {
		...
		//if *shoot.Spec.Kubernetes.KubeProxy.Enabled != true {
		if shoot.Spec.Kubernetes.KubeProxy.Mode != nil && *shoot.Spec.Kubernetes.KubeProxy.Mode != core.ProxyModeIPTables {
