...
import (
	...
	_ "github.com/gardener/gardener-extension-networking-calico/test/integration/healthcheck"
...
func TestGardenerSuite(t *testing.T) {
	RunSpecsWithDefaultAndCustomReporters(t, "Networking-calico Test Suite", []Reporter{reporter.NewGardenerESReporter(*reportFilePath, *esIndex)})
}
